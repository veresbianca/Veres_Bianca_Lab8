...
namespace Veres_Bianca_Lab8.Models
{
    public class BookCategoriesPageModell : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Veres_Bianca_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Veres_Bianca_Lab8Context context, string[] selectedCategories, Book bookToUpdate)
        {
